...
export const CONTROL_API_VERSION = 19;
...
export type AdoptRequest = { client: string, 
/**
 ...
 */
key_masked?: string | null, provider: string, 
/**
 ...
 */
model: string, method: string, path: string, at_ms: number, } | { "kind": "request_headers", id: number, status: number, ttfb_ms: number, } | { "kind": "request_finished", id: number, 
/**
 ...
 */
blocked: boolean, at_ms: number, } | { "kind": "scan_alert", id: number, alerts: Array<ScanFinding>, at_ms: number, } | { "kind": "request_priced", id: number, cost_micros?: number | null, cost_estimated?: boolean, cache_saved_micros?: number | null, at_ms: number, } | { "kind": "clients_changed", id: number, at_ms: number, } | { "kind": "health_changed", id: number, provider: string, 
/**
 ...
 */
export type RoutingView = { rule: string, group?: string | null, attempts: Array<AttemptView>, };
 ...
 */
export type ScanRequest = { projects: Array<string>, };
 ...
 */
export type ScanResponse = { findings: Array<ScanFinding>, mcp: Array<McpView>, skills: Array<SkillView>, hooks: Array<HookView>, 
/**
...
export const ENDPOINTS = {
  ...
  Scan: { method: "POST", path: "/scan", params: [], format: "json" },
  Clients: { method: "GET", path: "/clients", params: [], format: "json" },
  PlanAdopt: { method: "POST", path: "/clients/plan", params: [], format: "json" },
  Adopt: { method: "POST", path: "/clients/adopt", params: [], format: "json" },
  PlanRestore: { method: "GET", path: "/clients/{id}/restore/plan", params: ["id"], format: "json" },
  Restore: { method: "POST", path: "/clients/{id}/restore", params: ["id"], format: "json" },
  Why: { method: "GET", path: "/clients/{id}/why", params: ["id"], format: "json" },
  ClientKey: { method: "POST", path: "/clients/{id}/key", params: ["id"], format: "json" },
  McpTargets: { method: "GET", path: "/mcp/targets", params: [], format: "json" },
  McpPlan: { method: "POST", path: "/mcp/plan", params: [], format: "json" },
  McpApply: { method: "POST", path: "/mcp/apply", params: [], format: "json" },
...
export type Endpoints = {
  ...
  Scan: { req: ScanRequest; res: ScanResponse };
  Clients: { req: null; res: ClientsResponse };
  PlanAdopt: { req: AdoptRequest; res: PlanView };
  Adopt: { req: AdoptRequest; res: AdoptResponse };
  PlanRestore: { req: null; res: PlanView };
  Restore: { req: null; res: AdoptResponse };
  Why: { req: null; res: Array<FindingView> };
  ClientKey: { req: null; res: ClientKey };
  McpTargets: { req: null; res: Array<McpTargetView> };
  McpPlan: { req: McpOpRequest; res: PlanView };
  McpApply: { req: McpOpRequest; res: AdoptResponse };
