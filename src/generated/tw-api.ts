...
export const CONTROL_API_VERSION = 25;
 ...
 * 一行请求头，配置里写的原样。
 */
export type HeaderView = { name: string, value: string, };
 ...
 * 界面拿到的那一把很快就过期。
 */
export type OAuthView = { endpoint: string, refresh: string, client_id?: string | null, client_secret?: string | null, 
/**
 ...
 */
export type ProviderInput = { name: string, base_url: string, 
/**
 ...
 * 其余请求头，按配置里的顺序，值原样
 */
headers?: Array<HeaderView>, oauth?: OAuthView | null, 
/**
 ...
 * 代理的用户名和密码。
 */
export type ProxyAuth = { user: string, pass: string, };
 ...
 * 检测一个代理，**不保存**。
 */
export type ProxyTest = { proxy: ProxyInput, 
/**
