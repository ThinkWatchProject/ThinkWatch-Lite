...
export const CONTROL_API_VERSION = 15;
...
export type KeySyncFailed = { client: string, name: string, error: string, };
 ...
 */
listen_error?: Msg | null, config_path: string, clients: number, providers: number, uptime_secs: number, 
/**
 ...
 * **没有价格就是 None，不是 0**
 */
cost_micros: number | null, duration_ms: number | null, error: string | null, 
/**
