 ...
 */
endpoint: string | null, shadows: Array<string>, 
/**
 ...
 */
draft?: RouteInput | null, dialect: string, input_tokens: number, max_tokens: number | null, 
/**
 ...
 */
model: string, source: string, message: Msg, 
/**
 ...
 */
detail: string, at_ms: number, } | { "kind": "credential_expired", id: number, provider: string, 
/**
 * 失效的原因，**已打码**
 */
detail: string, at_ms: number, } | { "kind": "login_finished", id: number, 
/**
 * 发起登录时拿到的 ID
 */
login: string, 
 ...
 */
status: string, provider?: string | null, error?: string | null, at_ms: number, } | { "kind": "translated", id: number, provider: string, from: string, to: string, 
/**
 ...
 */
state: string, at_ms: number, } | { "kind": "models_changed", id: number, provider: string, at_ms: number, } | { "kind": "proxy_changed", id: number, proxy: string, 
/**
 ...
 * `ui` / `cli` / `external` / `rollback` / `rotation`
 */
origin: string, at_ms: number, } | { "kind": "config_rejected", id: number, 
/**
 ...
 */
origin: string, at_ms: number, } | { "kind": "locally_answered", id: number, client: string, 
/**
 ...
 */
probe: string, at_ms: number, } | { "kind": "events_dropped", id: number, count: number, at_ms: number, };
 ...
 */
level: string, title: Msg, detail: Msg, 
/**
 ...
 * 新建或修改一个策略组时交过来的定义。
 */
export type GroupInput = { name: string, 
/**
 ...
 */
export type L1Skip = { stage: L1Stage, 
/**
 ...
 * `off` / `observe` / `enforce`
 */
mode: string, base_version?: string | null, };
 ...
 * 没从上游拿到清单的原因
 */
error?: string | null, models: Array<ModelRow>, };
 ...
 * 按哪种协议测的
 */
protocol: string | null, latency_ms: number, models: ModelList, 
/**
 * 经由哪个代理。直连时为空
 */
via?: string | null, error: string | null, };
 ...
 */
kind: string, client: string, path: string, 
/**
 * 第几行，从 1 开始
 */
 ...
 */
export type SecurityEventsQuery = { guard?: string | null, from_ms?: number | null, to_ms?: number | null, 
/**
 * 只要这条之前的（翻页）
 */
