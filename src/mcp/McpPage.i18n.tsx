...
export const mcpText = messages(
  {
    ...
    // 同名不同配置的对比
    compareTitle: (name: string) => `${name} 在各客户端中的配置不一致`,
    compareDesc: "不一致的字段已标出。",
    env: "环境变量",
    noEnv: "（无）",
  ...
  },
  {
    ...
    compareTitle: (name: string) => `${name} is configured differently across clients`,
    compareDesc: "The fields that differ are highlighted.",
    ...
    noHooks: "No hooks are configured.",
