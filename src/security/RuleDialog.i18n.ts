...
export const ruleDialogText = messages(
  {
    ...
    cut: "切断",
    record: "仅记录",
    cutWhat: "命中的调用不会完整到达客户端，因而无法执行。",
    recordWhat: "命中的调用照常返回，只记入日志。",
    /** 内置规则改过处置时补的一句 */
  ...
  },
  {
    ...
    cut: "Cut off",
    record: "Record only",
    cutWhat: "A matching call never fully reaches the client, so it cannot run. ",
    recordWhat: "A matching call is returned as usual and recorded in the log. ",
